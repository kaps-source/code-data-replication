...
#Execution Workflow: All scripts are configured to run using relative paths assuming the root folder of this repository as the working directory.
...
2. Correspondence Analysis & K-Means Clustering (Figure 3).
  ...
  - Input: data/data_freq_unigrams.csv
  - Description: Performs Correspondence Analysis (CA), determines optimal $k$ via Elbow and Silhouette methods, executes k-means (k=4), generates the CA Biplot (Figure 3a), specificity charts (Figure 3b), and identifies the 20 articles closest to cluster centroids.
...
4. Clustered Heatmap of Qualitative Codes (Figure 5)
  ...
  -Description: Aggregates qualitative code presence/absence proportions across the 20 focal articles and generates the hierarchical clustered heatmap (Figure 5a).
